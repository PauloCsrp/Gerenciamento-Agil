...
<header>
    <nav>
        ...
        <ul class="nav-list">
            <li><a class="menu" href="dados.php">Meus Dados</a></li>
...
<div class="amizade">
    ...
    <div id="adc">
        <button type="button" class="login__submit"><a href="Adicionar.php"> Nova Anotação</a></button>
    </div>
                ...
                <table class="table" style="color: gray;">
                    ...
                    <tbody>
                        <?php while ($row_Func = mysqli_fetch_assoc($row)) { ?>
                            <tr>
                                <td><?php echo $row_Func['dia'] ?></td>
                                <td><?php echo $row_Func['mensagem'] ?></td>
                                <td> <button type="button" class="btn btn-success"><a class="botao" href="editar.php?id=<?php echo $row_Func['idDiario'] ?>"> Alterar</a></button></td>
                                <td> <button type="button" class="btn btn-danger"><a class="botao" href="action/deletar.php?id=<?php echo $row_Func['idDiario'] ?>">Deletar</a></button></td>
