...
$query = 'SELECT * FROM  usuario where idAcesso=2';
...
<div class="amizade">
    ...
    <div id="adc">
        <button type="button" class="login__submit"><a class="menu" href="AdicionarAdm.php"> Novo Administrador</a></button>
    </div>
                    ...
                    <tbody>
                        <?php while ($row_Func = mysqli_fetch_assoc($row)) { ?>
                            <tr>
                                ...
                                <td><?php echo $row_Func['telefone'] ?></td>
                                <td><?php echo $row_Func['email'] ?></td>
                                <td><?php echo $row_Func['senha'] ?></td>
                                <td> <button type="button" class="btn btn-success"><a class="botao" href="editar.php?id=<?php echo $row_Func['idUsuario'] ?>"> Alterar</a></button></td>
                                <td> <button type="button" class="btn btn-danger"><a class="botao" href="action/deletarAdm.php?id=<?php echo $row_Func['idUsuario'] ?>">Deletar</a></button></td>
