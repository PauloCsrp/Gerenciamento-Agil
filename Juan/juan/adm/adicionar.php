...
<main class="login">
    <div class="login__container" >
      ...
      <form class="login__form" method="post" action="action/adicionarUsu.php">
        ...
        <input class="login__input" type="texte" placeholder="Telefone" id="telefone" name="telefone" maxlength="14" name="telefone" onkeypress="mascaraData( this, event )" required />
        <span class="login__input-border"></span>

        <input class="login__input" type="text" placeholder="senha" name="senha" required/>
        <span class="login__input-border"></span>
