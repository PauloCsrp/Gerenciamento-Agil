...
$query = 'SELECT * FROM  usuario where idAcesso=1';
                    ...
                    <tbody>
                        <?php while ($row_Func = mysqli_fetch_assoc($row)) { ?>
                            <tr>
                                ...
                                <td> <button type="button" class="btn btn-danger"><a class="botao" href="action/deletar.php?id=<?php echo $row_Func['idUsuario'] ?>">Deletar</a></button></td>
